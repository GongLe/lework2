    ...
    <div id="main-content">
        ...
        <div id="main-body">
            <div id="main-body-content">
                <h3>标题title <button class="btn btn-danger btn-sm" hidefocus="true" id="demoCreate">新建</button> </h3>
        <%--        <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default"  >
                            ...
                            <div class="panel-body" style="padding: 5px 15px;">
                                <form class="navbar-form" style="padding-top: 0px;padding: 0px 0 0 0;" role="form">
                                    <div class="btn-group inline" style="font-size: 14px">
                                        <button type="button" class="btn btn-white"><i class="icon-check-empty"></i> </button>
                                    </div>
                                    <div class="btn-group inline" style="font-size: 14px">
                                        <button type="button" class="btn btn-white"><i class="icon-trash"></i></button>
                                        <button type="button" class="btn btn-white"><i class="icon-refresh"></i></button>
                                    </div>
                                    &nbsp;&nbsp;
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div id="table-list_wrapper" class="dataTables_wrapper dataTable-box" role="grid">
                            <div id="table-list_processing" class="dataTables_processing" style="visibility: hidden;">
                                &nbsp;</div>
                            <table id="table-list"
                                   class="table table-hover  table-nomargin table-striped -table-bordered dataTable dataTable-nosort clear-both"
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting_disabled" tabindex="0" rowspan="1" colspan="1" aria-label="操作"
                                        style="width: 125px;">操作
                                    </th>
                                </tr>
                                </thead>
                                ...
                                <tr class="odd">
                                    ...
                                    <td class="">
                                        <!-- Single button -->
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-white btn-xs dropdown-toggle normaler" data-toggle="dropdown">
                                                操作<span class="caret"></span>
                                            </button>
                                            <ul class="dropdown-menu dropdown-menu-rowaction" role="menu">
                                                <li><a href="#">查看</a></li>
                                                <li><a href="#">修改</a></li>
                            ...
                            <div class="table-footer clearfix">
                                ...
                                <div class="dataTables_paginate paging_full_numbers" id="table-list_paginate"><a
                                        tabindex="0" class="first paginate_button paginate_button_disabled"
                                        id="table-list_first">首页</a><a tabindex="0"
                                                                       class="previous paginate_button paginate_button_disabled"
                                                                       id="table-list_previous"> 上一页 </a><span><a
      ...
      <div class="row">
          ...
          <div class="col-md-12">
              ...
              <div id="table-list_wrapper2" class="dataTables_wrapper  " role="grid">
                  ...
                  <table id="table-list2"  cellspacing="0"
                         class="table table-hover table-striped -table-bordered dataTable dataTable-nosort clear-both"
                         aria-describedby="table-list_info">
                      <thead>
                      <tr role="row">
                          <th  tabindex="0" rowspan="1" colspan="1"  style="width:20px;"  >
                      ...
                      <tr class="odd">
                          ...
                          <td class=" sorting_1"><a href="javascript:;">管理员test长度................</a>
                              <div class="row-actions">
                                  <span><a href="#" class="info"  ><i class="icon-refresh"></i></a> | </span>
                                  <span><a class="info" href="#" title="编辑此项目"><i class="icon-edit"></i></a> | </span>
                                  <span><a class="danger" href="#"><i class="icon-trash"></i></a></span>
                              </div>
                          </td>
                          <td class="">admin</td>
                          <td class="">
